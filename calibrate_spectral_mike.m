function [data,mesh] = calibrate_spectral_mike(homog_data,...
    anom_data,...
    mesh_homog,...
    mesh_anom,...
    frequency,...
...
for i=1:2:k
    ...
    if frequency == 0
        ...
        [mua_h,mus_h,lnI_h,phase_h,data_h_fem] = fit_data_mike(wvmesh,...
            paa_homog(:,i:i+1),...
            frequency,...
            iteration);
    end
    ...
    if frequency == 0
        ...
        [mua_a,mus_a,lnI_a,phase_a,data_a_fem] = fit_data_mike(wvmesh,...
            paa_anom(:,i:i+1),...
            frequency,...
            iteration);
    end
    ...
    % These 2 lines are what are in the original calibrate.
